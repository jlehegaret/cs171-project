SpecVis = function (_parentElement, _data, _eventHandler, _options) {
    ...
    this.options = _options || {width: 600, height: 520,
    ...
    // defines constants
    this.margin = {top: 0, right: 20, bottom: 20, left: 50};
...
SpecVis.prototype.initVis = function () {
    ...
    this.svg = this.parentElement.append("svg")
        ...
        .attr("transform", "translate(" + (this.margin.left + this.margin.right + this.width) /1.8 + ","
